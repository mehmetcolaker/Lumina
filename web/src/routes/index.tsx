  ...
  head: () => ({
    meta: [
      { title: "Lumina — Learn to code, light up your future" },
      {
        name: "description",
        content:
          "Lumina offers interactive coding courses in Python, JavaScript, Web Dev, Data Science and AI. Learn by doing — at your own pace.",
      },
    ],
  }),
});
...
const stats = [
  { icon: Users, num: 0, suffix: "", label: "Active learning paths", display: "5" },
  { icon: Trophy, num: 0, suffix: "", label: "Hands-on courses", display: "Live" },
...
const plans = [
  {
    ...
    features: ["100+ free courses", "Practice exercises", "Community support"],
    cta: "Start free",
  },
  {
    name: "Plus",
    ...
    features: ["All courses & paths", "Guided practice", "Certificates", "Submission history"],
    cta: "Try Plus",
    featured: true,
  },
  {
    ...
    features: ["Everything in Plus", "Interview prep", "Job-ready portfolio", "Priority support"],
    cta: "Go Pro",
  },
];
...
const testimonials = [
  {
    ...
    quote: "Lumina took me from zero to hired in 7 months. The projects made all the difference.",
  },
  {
    name: "Daniel K.",
    role: "Data Analyst",
    quote:
      "The interactive lessons feel like a real classroom. I actually look forward to studying.",
  },
  {
    name: "Aisha P.",
    role: "AI Engineer",
    quote: "The AI path is rigorous and practical. I deployed real models by week three.",
  },
];

const steps = [
  { icon: GraduationCap, title: "Pick a path", desc: "Choose a structured programming roadmap." },
...
const faqs = [
  {
    ...
    a: "No — most courses begin from absolute beginner level with zero setup needed.",
  },
  {
    q: "How long does a career path take?",
    a: "Most learners complete a path in 6–10 months studying ~10 hours per week.",
  },
  {
    q: "Are certificates recognized?",
    a: "Certificates show completed Lumina coursework and can be shared with your portfolio.",
  },
  {
    q: "Can I cancel anytime?",
    a: "Absolutely. Cancel your subscription at any time from your account settings.",
  },
];
...
function Home() {
  ...
  const filtered = useMemo(
    () =>
      courses.filter(
        (c) =>
          (tag === "All" || c.tag === tag) && c.title.toLowerCase().includes(query.toLowerCase()),
      ),
    [query, tag],
  );
  ...
  return (
    <Layout>
      ...
      <section id="home" className="relative overflow-hidden">
        ...
        <div
          className="pointer-events-none absolute top-40 -right-20 h-80 w-80 rounded-full bg-primary-glow/40 blur-3xl animate-blob"
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2 md:py-28">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-lg text-lg text-muted-foreground animate-fade-in-up delay-200">
              Interactive lessons, real projects, and career paths that take you from beginner to
              job-ready — all in your browser.
            </p>
            <div className="mt-8 flex flex-wrap gap-3 animate-fade-in-up delay-300">
              <Button
                size="lg"
                asChild
                className="group bg-[image:var(--gradient-primary)] text-primary-foreground shadow-[var(--shadow-soft)] transition-all hover:opacity-90 hover:-translate-y-0.5 glow-on-hover"
              >
                <Link to="/courses">
                  Start learning free{" "}
          ...
          <div className="relative animate-scale-in delay-200">
            ...
            <img
              src={hero}
              alt="Lumina interactive learning"
              className="relative rounded-2xl shadow-[var(--shadow-card)] animate-float"
            />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <div className="mt-6 grid grid-cols-3 gap-6 text-sm font-bold text-foreground/60 md:grid-cols-6">
            {["Google", "Meta", "Amazon", "Microsoft", "Netflix", "Spotify"].map((b) => (
              <div key={b} className="hover-scale transition-colors hover:text-foreground">
                {b}
              </div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-6 md:grid-cols-4">
            {steps.map((s, i) => (
              <Card
                key={s.title}
                className="border-border p-6 hover-lift animate-fade-in-up"
        ...
        <div className="mb-8 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
          <div className="animate-fade-in-up">
            ...
            <p className="mt-3 text-muted-foreground">
              Hands-on courses crafted by industry experts.
            </p>
          </div>
            ...
            {filtered.map((c, i) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <Badge
                    variant="secondary"
                    className="bg-accent text-accent-foreground transition-transform group-hover:scale-105"
                  >
                    {c.tag}
                  </Badge>
                ...
                <button className="story-link mt-4 text-sm font-medium text-primary">
                  Start course →
                </button>
              </Card>
            ))}
      ...
      <section id="paths" className="bg-secondary/40 py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-12 text-center animate-fade-in-up">
            ...
            <p className="mt-3 text-muted-foreground">
              Step-by-step roadmaps built with hiring managers.
            </p>
          </div>
            ...
            {paths.map((p, i) => (
              ...
              >
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  {p.courses} courses · ~{p.months} months
                </p>
                <div className="mt-4 flex items-center text-sm font-medium text-primary">
                  View roadmap{" "}
                  <ArrowRight className="ml-1 h-4 w-4 transition-transform group-hover:translate-x-2" />
      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2">
        <div className="animate-fade-in-up">
          <h2 className="text-3xl font-bold text-foreground md:text-4xl">
            Why learners choose Lumina
          </h2>
          <p className="mt-4 text-muted-foreground">
            Our hands-on platform combines bite-sized lessons, runnable practice, and structured
            roadmaps so you actually learn — and remember — what matters.
          </p>
          <ul className="mt-6 space-y-3 text-sm text-foreground">
            {[
              "Code in your browser — no setup",
        ...
        <Card className="border-border bg-card p-8 shadow-[var(--shadow-card)] hover-lift animate-scale-in">
          <div className="rounded-lg bg-foreground p-4 font-mono text-xs text-background">
            ...
            <div>
              <span className="text-primary-glow">function</span> learn() {`{`}
            </div>
            <div className="pl-4">
              return <span className="text-primary-glow">'progress'</span>;
            </div>
            <div>{`}`}</div>
          </div>
          <div className="mt-6">
            <div className="text-sm font-semibold text-foreground">
              Lesson 3 of 12 · JavaScript Basics
            </div>
      ...
      <section id="pricing" className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {plans.map((p, i) => (
            ...
            >
              {p.featured && (
                <Badge className="mb-3 w-fit bg-[image:var(--gradient-primary)] text-primary-foreground">
                  Most popular
                </Badge>
              )}
              ...
              {p.name === "Basic" ? (
                <Button
                  className="mt-8 transition-all hover:-translate-y-0.5"
                  variant="outline"
                  asChild
                >
                ...
                <Button
                  className={`mt-8 transition-all hover:-translate-y-0.5 ${p.featured ? "bg-[image:var(--gradient-primary)] text-primary-foreground hover:opacity-90" : ""}`}
                  variant={p.featured ? "default" : "outline"}
                  onClick={startCheckout}
                  disabled={checkoutLoading}
                >
                  {checkoutLoading ? "Starting..." : p.cta}
                </Button>
              )}
            </Card>
          ))}
      ...
      <section id="business" className="bg-[image:var(--gradient-hero)] py-20">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 md:grid-cols-2 md:items-center">
          <div className="animate-fade-in-up">
            ...
            <p className="mt-4 text-muted-foreground">
              Hands-on tech training trusted by 1,000+ companies. SSO, analytics, custom paths and
              SOC 2 compliance.
            </p>
            <div className="mt-6 flex gap-3">
              <Button
                size="lg"
                className="bg-[image:var(--gradient-primary)] text-primary-foreground shadow-[var(--shadow-soft)] hover:opacity-90 hover:-translate-y-0.5 transition-all"
              >
                Request a demo
              </Button>
        ...
        <Accordion type="single" collapsible className="space-y-3">
          {faqs.map((f, i) => (
            <AccordionItem
              key={f.q}
              value={`item-${i}`}
              className="rounded-lg border border-border bg-card px-6 animate-fade-in-up"
              style={{ animationDelay: `${i * 80}ms` }}
            >
      ...
      <section className="relative overflow-hidden bg-[image:var(--gradient-primary)] py-20 text-center">
        ...
        <div className="relative mx-auto max-w-3xl px-6">
          ...
          <p className="mt-3 text-primary-foreground/90">
            Join millions learning with Lumina — free to start, forever.
          </p>
