...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Lumina's mission is to light up the future of learners worldwide.",
      },
  ...
  return (
    <Layout>
      <section className="relative overflow-hidden border-b border-border bg-[image:var(--gradient-hero)]">
        ...
        <div
          className="absolute -bottom-20 right-10 h-80 w-80 rounded-full bg-accent/40 blur-3xl animate-blob"
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-24 text-center">
          ...
          <Reveal delay={200}>
            <p className="mt-6 text-lg text-muted-foreground">
              Lumina was built to make world-class coding education accessible, joyful, and
              effective — for every curious mind on the planet.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <Reveal>
          <Card className="p-10 text-center bg-[image:var(--gradient-primary)] text-primary-foreground border-0">
            ...
            <p className="mt-4 text-lg opacity-95">
              To light up the path to a fulfilling tech career — one lesson, one project, one
              learner at a time.
            </p>
          </Card>
        </Reveal>
